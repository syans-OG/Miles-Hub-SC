--[[
    ⚡ Miles-HUB v2.4 — Game Script (Grow A Chicken Fighter)
    
    This file is fetched by MilesHub_Loader.lua
    Do NOT run this directly — use the loader instead!
    
    loadstring(game:HttpGet("https://raw.githubusercontent.com/syans-OG/Miles-Hub-SC/main/MilesHub_Loader.lua"))()
]]

print("[Miles-HUB] Game script loaded ✓")
...
-- ═══ Find GUI parent (reuse from loader if available) ═══
local guiParent = nil
pcall(function()
...
if not guiParent then
    pcall(function() guiParent = LP:WaitForChild("PlayerGui", 5) end)
end
...
pcall(function()
    ...
    pcall(function() floatGui.Parent = guiParent end)
    if not floatGui.Parent then
        pcall(function() floatGui.Parent = LP:WaitForChild("PlayerGui", 5) end)
    end
...
print("[Miles-HUB] Game script ready ✓ — RightShift to toggle GUI")
