--[[
    ⚡ Miles-HUB v5.0 — DEBUG VERSION
    Paste langsung ke executor.
    Buka Dev Console (F9) untuk lihat debug output.
    Hotkey: RightShift = Toggle GUI
]]

print("=== [MILES-HUB] STEP 0: Script started ===")
...
print("=== [MILES-HUB] STEP 1: Services OK ===")
...
-- ═══ GUI ═══
print("=== [MILES-HUB] STEP 2: Creating GUI ===")
local gui = Instance.new("ScreenGui")
gui.Name = "MilesHub"
gui.ResetOnSpawn = false
gui.DisplayOrder = 999999
gui.Parent = LP:WaitForChild("PlayerGui")
print("=== [MILES-HUB] STEP 3: GUI parented to PlayerGui ===")
...
print("=== [MILES-HUB] STEP 4: UI Helpers OK ===")
...
print("=== [MILES-HUB] STEP 5: Remotes OK ===")
...
print("=== [MILES-HUB] STEP 6: Home Tab OK ===")
...
print("=== [MILES-HUB] STEP 7: Egg Tab OK ===")
...
print("=== [MILES-HUB] STEP 8: Farm Tab OK ===")
...
print("=== [MILES-HUB] STEP 9: Upgrade Tab OK ===")
...
print("=== [MILES-HUB] STEP 10: Floating button OK ===")
...
print("=== [MILES-HUB] STEP 11: InfJump OK ===")
...
print("=== [MILES-HUB] STEP 12: Speed/NoClip OK ===")

-- Anti-AFK (using only Idled event, NO VirtualUser/VirtualInputManager)
pcall(function()
...
print("=== [MILES-HUB] STEP 13: Anti-AFK OK ===")

-- Auto loops
task.spawn(function() while task.wait(1) do if Flags.AutoHatch then pcall(function() Fire("HatchEgg", Flags.SelectedEgg, 1) end) task.wait(Flags.HatchDelay) if Flags.AutoSellOnHatch then pcall(function() Fire("SellChicken", "All") end) end end end end)
...
print("=== [MILES-HUB] STEP 14: Auto Loops OK ===")

-- ═══ DONE ═══
Notify("Loaded! RightShift = toggle GUI")
print("=== [MILES-HUB] v5.0 ALL DONE ===")
